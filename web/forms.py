...
class ReportLost(FlaskForm):
    ...
    name = StringField('Name of pet', validators=[DataRequired("Enter the pet's name")])
    age = IntegerField('Pets age')
    colour = StringField('Colour')
    sex = SelectField(choices=[('Male', 'Male'), ('Female', 'Female')])
    breed = StringField('Breed')
    location = StringField('City/Town', validators=[DataRequired("Enter your location")])
    postcode = StringField('Postcode (e.g. BT45 or CR0)', validators=[DataRequired("Enter your postcode")])
...
class ReportFound(FlaskForm):
    ...
    breed = StringField('Breed')
    location = StringField('City/Town', validators=[DataRequired("Enter your location")])
    postcode = StringField('Postcode', validators=[DataRequired("Enter your postcode")])
    animal = SelectField(choices=[('Dog', 'Dog'), ('Cat', 'Cat'), ('Rabbit', 'Rabbit'),
                                  ('Bird', 'Bird'), ('Horse', 'Horse'), ('Other', 'Other')])
    collar = BooleanField('Collar')
    chipped = BooleanField('Chipped')
...
class ResgisterPet(FlaskForm):
    ...
    image = FileField('Image File')
    name = StringField('Name', validators=[DataRequired("Enter the pet's name")])
    colour = StringField('Colour')
    sex = SelectField(choices=[('Male', 'Male'), ('Female', 'Female')])
    breed = StringField('Breed')
    location = StringField('City/Town', validators=[DataRequired("Enter your location")])
