...
class VideoClassifier {
    ...
    func detectDog(sampleBuffer: CMSampleBuffer) {
        ...
        let imageRequestHandler = VNImageRequestHandler(cvPixelBuffer: pixelBuffer, orientation: CGImagePropertyOrientation(rawValue: CGImagePropertyOrientation.RawValue(self.exifOrientationFromDeviceOrientation))!, options: getOptionsForImageBuffer(pixelBuffer))
        do {
